...
import com.vend.fmr.aieng.DisabledSpringAiChatModel
...
class SpringAiController {
    ...
    fun springAiDemo(model: Model): String {
        ...
        if (chatModel is DisabledSpringAiChatModel) {
            model.addAttribute("error", "Spring AI is not available - OPEN_AI_KEY environment variable is required")
            return "spring-ai-demo"
        }
        
        model.addAttribute("defaultText", "Spring AI provides a comprehensive framework for building AI applications. It offers abstractions for various AI providers, prompt templates, and seamless integration with the Spring ecosystem.")
    ...
    fun processSpringAi(
        ...
        val defaultText = "Spring AI provides a comprehensive framework for building AI applications. It offers abstractions for various AI providers, prompt templates, and seamless integration with the Spring ecosystem."
